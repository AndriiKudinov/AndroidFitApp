...
public class PullActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        weekText = findViewById(R.id.pull_text1);
        weekText.setGravity(Gravity.CENTER);
        quantText = findViewById(R.id.pull_text2);
        quantText.setGravity(Gravity.CENTER);

        ex1 = findViewById(R.id.pull_ex_text1);
        ex2 = findViewById(R.id.pull_ex_text2);
        ex3 = findViewById(R.id.pull_ex_text3);
        ex4 = findViewById(R.id.pull_ex_text4);
        ex5 = findViewById(R.id.pull_ex_text5);
        minus = findViewById(R.id.pull_button);
        minus.setOnClickListener(this);
        plus = findViewById(R.id.pull_button2);
        plus.setOnClickListener(this);
        load_ex();

        weekText.setText(String.format("Неделя %d - День %d", weekNum, dayNum));
        exMain = findViewById(R.id.pull_text3);
        exMain.setText(String.format("%d", Integer.parseInt(ex1.getText().toString())));
        ready_button = findViewById(R.id.pull_text4);
        ready_button.setOnClickListener(this);
        finish_button = findViewById(R.id.pull_button3);
        finish_button.setOnClickListener(this);

        progress = (ProgressBar) findViewById(R.id.pull_Progress);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.pull_button:
                ...
                if(Integer.parseInt(ex1.getText().toString()) > 1){
    ...
    void save_ex(){
        ...
        editor1.putString("ex1_Text_pull", ex1.getText().toString());
        editor1.commit();
        pref2 = getPreferences(MODE_PRIVATE);
        SharedPreferences.Editor editor2 = pref2.edit();
        editor2.putString("ex2_Text_pull", ex2.getText().toString());
        editor2.commit();
        pref3 = getPreferences(MODE_PRIVATE);
        SharedPreferences.Editor editor3 = pref3.edit();
        editor3.putString("ex3_Text_pull", ex3.getText().toString());
        editor3.commit();
        pref4 = getPreferences(MODE_PRIVATE);
        SharedPreferences.Editor editor4 = pref4.edit();
        editor4.putString("ex4_Text_pull", ex4.getText().toString());
        editor4.commit();
        pref5 = getSharedPreferences("days", MODE_PRIVATE);
        SharedPreferences.Editor editor5 = pref5.edit();
        editor5.putInt("week_num_pull", weekNum);
        editor5.commit();
        pref6 = getSharedPreferences("days", MODE_PRIVATE);
        SharedPreferences.Editor editor6 = pref6.edit();
        editor6.putInt("day_num_pull", dayNum);
        editor6.commit();
    }

    void load_ex(){
        pref1 = getPreferences(MODE_PRIVATE);
        String savedEx1Text = pref1.getString("ex1_Text_pull", "1");
        ex1.setText(savedEx1Text);
        pref2 = getPreferences(MODE_PRIVATE);
        String savedEx2Text = pref2.getString("ex2_Text_pull", "1");
        ex2.setText(savedEx2Text);
        pref3 = getPreferences(MODE_PRIVATE);
        String savedEx3Text = pref3.getString("ex3_Text_pull", "1");
        ex3.setText(savedEx3Text);
        pref4 = getPreferences(MODE_PRIVATE);
        String savedEx4Text = pref4.getString("ex4_Text_pull", "1");
        ex4.setText(savedEx4Text);
        pref5 = getSharedPreferences("days", MODE_PRIVATE);
        int savedWeek = pref5.getInt("week_num_pull", 1);
        weekNum = savedWeek;
        pref4 = getSharedPreferences("days", MODE_PRIVATE);
        int savedDay = pref5.getInt("day_num_pull", 1);
        dayNum = savedDay;
    }
}
